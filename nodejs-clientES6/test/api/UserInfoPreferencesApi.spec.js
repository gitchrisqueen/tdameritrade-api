  ...
  describe('UserInfoPreferencesApi', function() {
    describe('accountsAccountIdPreferencesGET', function() {
      it('should call accountsAccountIdPreferencesGET successfully', function(done) {
        //uncomment below and update the code to test accountsAccountIdPreferencesGET
        //instance.accountsAccountIdPreferencesGET(function(error) {
    ...
    describe('accountsAccountIdPreferencesPUT', function() {
      it('should call accountsAccountIdPreferencesPUT successfully', function(done) {
        //uncomment below and update the code to test accountsAccountIdPreferencesPUT
        //instance.accountsAccountIdPreferencesPUT(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('userprincipalsGET', function() {
      it('should call userprincipalsGET successfully', function(done) {
        //uncomment below and update the code to test userprincipalsGET
        //instance.userprincipalsGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('userprincipalsStreamersubscriptionkeysGET', function() {
      it('should call userprincipalsStreamersubscriptionkeysGET successfully', function(done) {
        //uncomment below and update the code to test userprincipalsStreamersubscriptionkeysGET
        //instance.userprincipalsStreamersubscriptionkeysGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
