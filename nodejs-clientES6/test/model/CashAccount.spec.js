...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitChrisQueen_TDA_JS.CashAccount();
  });
  ...
  describe('CashAccount', function() {
    it('should create an instance of CashAccount', function() {
      // uncomment below and update the code to test CashAccount
      //var instane = new GitChrisQueen_TDA_JS.CashAccount();
      //expect(instance).to.be.a(GitChrisQueen_TDA_JS.CashAccount);
    });
