...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitChrisQueen_TDA_JS.ETFQuote();
  });
  ...
  describe('ETFQuote', function() {
    it('should create an instance of ETFQuote', function() {
      // uncomment below and update the code to test ETFQuote
      //var instane = new GitChrisQueen_TDA_JS.ETFQuote();
      //expect(instance).to.be.a(GitChrisQueen_TDA_JS.ETFQuote);
    });
