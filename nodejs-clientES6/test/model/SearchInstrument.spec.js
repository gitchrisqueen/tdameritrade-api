...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitChrisQueen_TDA_JS.SearchInstrument();
  });
  ...
  describe('SearchInstrument', function() {
    it('should create an instance of SearchInstrument', function() {
      // uncomment below and update the code to test SearchInstrument
      //var instane = new GitChrisQueen_TDA_JS.SearchInstrument();
      //expect(instance).to.be.a(GitChrisQueen_TDA_JS.SearchInstrument);
    });
