...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitChrisQueen_TDA_JS.OrderActivity();
  });
  ...
  describe('OrderActivity', function() {
    it('should create an instance of OrderActivity', function() {
      ...
      //var instane = new GitChrisQueen_TDA_JS.OrderActivity();
      //expect(instance).to.be.a(GitChrisQueen_TDA_JS.OrderActivity);
    });
