...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @GitchrisqueenTdameritradeApiJsClient.CandleList();
  });
  ...
  describe('CandleList', function() {
    it('should create an instance of CandleList', function() {
      ...
      //var instane = new @GitchrisqueenTdameritradeApiJsClient.CandleList();
      //expect(instance).to.be.a(@GitchrisqueenTdameritradeApiJsClient.CandleList);
    });
