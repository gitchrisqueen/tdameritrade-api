...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @GitchrisqueenTdameritradeApiJsClient.Instrument();
  });
  ...
  describe('Instrument', function() {
    it('should create an instance of Instrument', function() {
      ...
      //var instane = new @GitchrisqueenTdameritradeApiJsClient.Instrument();
      //expect(instance).to.be.a(@GitchrisqueenTdameritradeApiJsClient.Instrument);
    });
