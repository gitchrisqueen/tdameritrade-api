...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @GitchrisqueenTdameritradeApiJsClient.EASObject();
  });
  ...
  describe('EASObject', function() {
    it('should create an instance of EASObject', function() {
      ...
      //var instane = new @GitchrisqueenTdameritradeApiJsClient.EASObject();
      //expect(instance).to.be.a(@GitchrisqueenTdameritradeApiJsClient.EASObject);
    });
