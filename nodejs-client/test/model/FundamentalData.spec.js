...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @GitchrisqueenTdameritradeApiJsClient.FundamentalData();
  });
  ...
  describe('FundamentalData', function() {
    it('should create an instance of FundamentalData', function() {
      ...
      //var instane = new @GitchrisqueenTdameritradeApiJsClient.FundamentalData();
      //expect(instance).to.be.a(@GitchrisqueenTdameritradeApiJsClient.FundamentalData);
    });
