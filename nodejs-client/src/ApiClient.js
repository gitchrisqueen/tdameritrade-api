...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.@GitchrisqueenTdameritradeApiJsClient.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.tdameritrade.com/v1
     */
    this.basePath = 'https://api.tdameritrade.com/v1'.replace(/\/+$/, '');
