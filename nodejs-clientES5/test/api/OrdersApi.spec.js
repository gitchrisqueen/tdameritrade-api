    ...
    describe('OrdersApi', function() {
      ...
      describe('accountsAccountIdOrdersOrderIdPUT', function() {
        it('should call accountsAccountIdOrdersOrderIdPUT successfully', function(done) {
          // TODO: uncomment, update parameter values for accountsAccountIdOrdersOrderIdPUT call
          /*
          var accountId = 56;
          var orderId = 56;
          var opts = {};
          ...
          instance.accountsAccountIdOrdersOrderIdPUT(accountId, orderId, opts).then(function(data) {
