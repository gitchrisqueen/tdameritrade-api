...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OptionDeliverableInner', function() {
      beforeEach(function() {
        instance = new GitChrisQueen_TDA_JS.OptionDeliverableInner();
      });

      it('should create an instance of OptionDeliverableInner', function() {
        // TODO: update the code to test OptionDeliverableInner
        expect(instance).to.be.a(GitChrisQueen_TDA_JS.OptionDeliverableInner);
      });
