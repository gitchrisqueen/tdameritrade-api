...
var BANNER = chalk.hex(CQCLightGoldHex)('Thank you for using tdameritrade-api ( ') +
    chalk.hex(CQCDarkGoldHex)('https://github.com/gitchrisqueen/tdameritrade-api') + chalk.hex(CQCLightGoldHex)(' ) for connecting to the TD Ameritrade API!\n\n' +
        'The project needs your help! Please consider supporting of tdameritrade-api on Open Collective or Patreon:\n') +
